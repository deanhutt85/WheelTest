...
class CreateTest:
    def new_test():
        ...
        checkretest = Checkbutton(newtestwindow, text="Retest?", variable=retest).grid(column=6, row=13)
        ...
        button1 = Button(newtestwindow, text="Button1", command=lambda: print(
            varPF0cwleft.get(),
            varPF0cwright.get(),
            varPF0ccwleft.get(),
            varPF0ccwright.get(),
